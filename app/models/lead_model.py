...
def build_lead_document(data: dict[str, Any], created_by: str) -> dict[str, Any]:
    ...
    return {
        ...
        "assignment_history": [],
        # If created with an assignee, populate initial assignment entry
        # Note: `assigned_to` may be an ObjectId or string; services may normalize it.
        # If `assigned_to` present in input data, a service should set it before calling this builder.
        "audit_logs": [],
