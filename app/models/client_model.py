...
def build_client_document(
    ...
    """
    now = datetime.utcnow()
    # Support explicit `client_name` while keeping `contact_person` for compatibility
    ...
    return {
        ...
        # Collections to hold client-associated records
...
def serialize_client(client: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "audit_logs": client.get("audit_logs", []),
